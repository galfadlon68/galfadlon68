...
//        testQ3E13();       //Runs tests for 3.13
    ...
    private static void testQ3E9() {
        ...
        BinaryNumber[] inputs = {new BinaryNumber('7'),
                ...
                calculate2Power32(),
                calculate2Power32Minus1(),
                calculate2Power32().negate(),
                calculate2Power32().negate().subtract(new BinaryNumber('1'))};
        String[] expectedOutputs = {"7", "0", "-4", "-32", "java.lang.RuntimeException", "2147483647", "-2147483648", "java.lang.RuntimeException"};
        for (int i = 0; i < inputs.length; i++) {
            try {
    ...
    private static BinaryNumber calculate2Power32() {
